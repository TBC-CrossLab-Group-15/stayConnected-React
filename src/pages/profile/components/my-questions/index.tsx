      ...
      {data?.map((question:Question) => (   
        ...
        > 
          ...
          <div className="flex flex-col gap-4 ">
            <div className="flex justify-between  items-start flex-col sm:flex-row  ">
              <h2 className="text-lg font-semibold text-gray-800 dark:text-gray-100 ">
                Title: {question?.title || "DataTitle"}
              </h2>
          ...
          <div className="flex flex-col gap-3 ">
            ...
            <Answers userId={userId} onApprove={onApprove} onRemove={onRemove} answerData={question?.answers} />
          </div>
          <Button 
        onClick={() => removeQuestion(question.id)}
        className="w-40 px-6 py-3  font-semibold rounded-lg shadow-md hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 transition-all duration-200 ease-in-out transform hover:scale-105" variant={"outline"}>
