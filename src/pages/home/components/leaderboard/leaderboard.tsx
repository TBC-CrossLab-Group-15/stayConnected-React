...
const Leaderboard: React.FC = () => {
  ...
  return (
    <div className="w-full p-5 flex-col sticky top-[90px] bg-gray-100 rounded-lg border shadow-lg dark:bg-black dark:border-solid dark:border-neutral-800">
      ...
      <div className="flex justify-between mb-6 gap-4  lg:flex-col xl:flex-row">
        {topThree.map((user, index) => {
          ...
          return (
            <div
              key={index}
              className={`flex flex-col items-center p-4 rounded-lg shadow ${colors[index]} w-1/3 lg:w-full xl:w-1/3`}
            >
